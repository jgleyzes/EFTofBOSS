...
EFT_PATH = opa.join(THIS_PATH,'RedshiftBiasEFT_v2.4/')# Expects the EFT code compiled here!!!
...
Seriescosmo = dfcosmo.loc['LightConeHector']
...
keys = ['b1','b2','b3','b4','b5','b6','b7','b8','b9','b10','DM','kren',
            ...
            'UseCosmoRef','ExportResummationMatrix','ImportResummationMatrix',
...
kclass,Pclass = (np.loadtxt(opa.abspath(opa.join(path,'class_planck2015_pk.dat')))).T
