...
def get_Pi_for_marg(Ploop,b1,bisp=None):
    Pi = np.array([Ploop[:,3,:]/(2.*np.pi)+b1*Ploop[:,7,:]/(2.*np.pi),
...
def computePS(cvals,datalin,dataloop,setkin,setkout,sigsq=0):
    ...
    #cvals = np.array([1,b1,b2,b3,b4,b1*b1,b1*b2,b1*b3,b1*b4,b2*b2,b2*b4,b4*b4*4.*np.pi/(4.+np.pi),b1*b5,b1*b6,b1*b7,b5,b6 ,b7,b8 ,b9,b10])
