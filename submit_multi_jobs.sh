...
sbatch --job-name=b$number.$kmax.$simname --output=outfiles/b$number.$kmax.$kmaxbisp.$simname.Planck$planck.out cluster_MCMC.sh $number $kmax $simname $planck conLightConeHectorwideh $kmaxbisp $marg
done
